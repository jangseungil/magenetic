...
<body>
	<form action="/m/home/user/insert" id="insertForm" method="post">
		<div class="insertDiv">
			<strong>name</strong>
	    ...
	    <thead>
	 	...
	 	<c:forEach var="userVo" items="${userVoList}" varStatus="status">
			...
			<tr class="${trClassNm}">
				...
				<td class="mtd_typeC">
					<a href="#" onclick="deleteUsr('/m/home/user/delete/${userVo.name}');"><img src="${pageContext.request.contextPath}/images/delete.png" width="20px"/></a>
				</td>
		    </tr>
	 	</c:forEach>
	    </tbody>
